...
%gitexe% log -1 --date=format:%%Y.%%m.%%d --pretty=format:"#define MPCIS_REV_DATE %%ad%%n" >> revision.h
%gitexe% log -1 --pretty=format:"#define MPCIS_REV_HASH %%h%%n" >> revision.h

<nul set /p strTemp=#define MPCIS_REV_NUM >> revision.h
